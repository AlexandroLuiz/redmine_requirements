...
A instalação do plugin é muito simples, primeiramente acesse: https://github.com/AlexandroLuiz/redmine_requirements.git e baixe esse plugin, estando no diretório do Redmine, colocando-o na pasta:
    "vendor/plugins"
